...
$insert="INSERT INTO `student` (`rollno`, `studentname`,`college`, `mobile`,`email`,`department`,`event_category`,`event`,`event_location`,`fee`) VALUES ('".$_POST['rollno']."', '".$_POST['studentname']."','".$_POST['college']."',  '".$_POST['mobile']."','".$_POST['email']."','".$_POST['department']."','".$_POST['event_category']."','".$_POST['event']."','".$_POST['event_location']."','".$_POST['fee']."')";
   $ins= mysqli_query($con,$insert);
     ...
     echo "<script>alert('Data inserted successfully');location.href='print.php?id=".base64_encode($id)."'</script>";	
     }
     else
     {
...
<div class="container ">
		<div class="row main">
			...
			<div class="col-md-8 col-md-offset-2 bg-" style="background-color: #000033;">
		...
		<div class="form-group  ">
			...
			<div class="cols-sm-10">
				<div class="input-group">
					...
					<input type="text" value="<?php  echo $fetch['rollno'];  ?>" class="form-control" name="rollno" id="studentid"  placeholder="Enter  id" required/>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="cols-sm-10">
				<div class="input-group">
					...
					<select name="event_location" class="form-control" id="event_location">
						<option value="billgates">Billgates</option>
